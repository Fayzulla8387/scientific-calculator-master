function display1(e) {
    var s = document.getElementById("expression1").value, n = s.length - 1;
...
function solve() {
    check = 1;
    var x = document.getElementById("expression1").value, o = expression2.indexOf("!");
    if (o > -1) for (var k = 0; k < expression2.length; k++) if ("!" == expression2[k]) if (")" == expression2[k - 1]) {
        for (var i = k - 1; "(" != expression2[i];) i -= 1;
        if ("." == expression2[i]) {
    ...
    if (p > -1) for (var k = 0; k < expression2.length; k++) if ("√" == expression2[k]) if ("(" == expression2[k + 1]) {
        for (var i = k + 2; ")" != expression2[i] && i != expression2.length;) i += 1;
        i == expression2.length && ")" != expression2[i] && (x += ")");
        var n = eval(expression2.substring(k + 2, i)), ans = Math.pow(n, .5);
        ...
        var n = eval(expression2.substring(k + 1, i)), ans = Math.pow(n, .5);
        expression2 = expression2.substring(0, k) + String(ans) + expression2.substring(i, expression2.length)
    }
    var q = expression2.indexOf("s");
    if (q > -1) for (var k = 0; k < expression2.length; k++) if ("s" == expression2[k]) if ("(" == expression2[k + 3]) {
        for (var i = k + 4; ")" != expression2[i] && i != expression2.length;) i += 1;
        i == expression2.length && ")" != expression2[i] && (x += ")");
        var n = eval(expression2.substring(k + 4, i)), ans = Math.sin(n / 180 * Math.PI);
        expression2 = expression2.substring(0, k) + String(ans) + expression2.substring(i + 1, expression2.length)
    } else {
        ...
        var n = eval(expression2.substring(k + 3, i)), ans = Math.sin(n / 180 * Math.PI);
        expression2 = expression2.substring(0, k) + String(ans) + expression2.substring(i, expression2.length)
    }
    var r = expression2.indexOf("c");
    if (r > -1) for (var k = 0; k < expression2.length; k++) if ("c" == expression2[k]) if ("(" == expression2[k + 3]) {
        for (var i = k + 4; ")" != expression2[i] && i != expression2.length;) i += 1;
        i == expression2.length && ")" != expression2[i] && (x += ")");
        var n = eval(expression2.substring(k + 4, i)), ans = Math.cos(n / 180 * Math.PI);
        expression2 = expression2.substring(0, k) + String(ans) + expression2.substring(i + 1, expression2.length)
    } else {
        for (var i = k + 3; 0 == expression2[i] || 1 == expression2[i] || 2 == expression2[i] || 3 == expression2[i] || 4 == expression2[i] || 5 == expression2[i] || 6 == expression2[i] || 7 == expression2[i] || 8 == expression2[i] || 9 == expression2[i] || "." == expression2[i];) i += 1;
        var n = eval(expression2.substring(k + 3, i)), ans = Math.cos(n / 180 * Math.PI);
        expression2 = expression2.substring(0, k) + String(ans) + expression2.substring(i, expression2.length)
    }
    var s = expression2.indexOf("t");
    if (s > -1) for (var k = 0; k < expression2.length; k++) if ("t" == expression2[k]) if ("(" == expression2[k + 3]) {
        for (var i = k + 4; ")" != expression2[i] && i != expression2.length;) i += 1;
        i == expression2.length && ")" != expression2[i] && (x += ")");
    ...
    if (t > -1) for (var k = 0; k < expression2.length; k++) if ("l" == expression2[k]) if ("(" == expression2[k + 3]) {
        for (var h = k + 4; ")" != expression2[h] && h != expression2.length;) h += 1;
        h == expression2.length && ")" != expression2[h] && (x += ")");
        var n = eval(expression2.substring(k + 4, h)), ans = Math.log10(n);
        ...
        var n = eval(expression2.substring(k + 3, h)), ans = Math.log10(n);
        expression2 = expression2.substring(0, k) + String(ans) + expression2.substring(h, expression2.length)
    }
    var u = expression2.indexOf("j");
    if (u > -1) for (var k = 0; k < expression2.length; k++) if ("j" == expression2[k]) if ("(" == expression2[k + 2]) {
        for (var i = k + 3; ")" != expression2[i] && i != expression2.length;) i += 1;
        i == expression2.length && ")" != expression2[i] && (x += ")");
        var n = eval(expression2.substring(k + 3, i)), ans = Math.log(n);
        expression2 = expression2.substring(0, k) + String(ans) + expression2.substring(i + 1, expression2.length)
    } else {
        ...
        var n = eval(expression2.substring(k + 2, i)), ans = Math.log(n);
        expression2 = expression2.substring(0, k) + String(ans) + expression2.substring(i, expression2.length)
    }
    var v = expression2.indexOf("a");
    if (v > -1) for (var k = 0; k < expression2.length; k++) if ("a" == expression2[k]) if ("(" == expression2[k + 3]) {
        for (var i = k + 4; ")" != expression2[i] && i != expression2.length;) i += 1;
        i == expression2.length && ")" != expression2[i] && (x += ")");
        var n = eval(expression2.substring(k + 4, i)), ans = Math.abs(n);
        expression2 = expression2.substring(0, k) + String(ans) + expression2.substring(i + 1, expression2.length)
    } else {
    ...
    if (expression2 != 1 / 0) {
        ...
        var z = y.toFixed(10), w = parseFloat(z);
...
function checkBalancedParentheses(e) {
    let s = [], n = {"(": ")", "[": "]", "{": "}"};
    for (let i = 0; i < e.length; i++) if ("(" === e[i] || "{" === e[i] || "[" === e[i]) s.push(e[i]); else if (")" === e[i] || "}" === e[i] || "]" === e[i]) {
        let r = s.pop();
        if (e[i] !== n[r]) return 0
    }
...
function back() {
    var e = document.getElementById("expression1").value, s = expression2[expression2.length - 2],
        n = expression2[expression2.length - 1], i = e[e.length - 2], r = e[e.length - 1];
...
function pi() {
    var e = document.getElementById("expression1").value, s = e.length - 1;
...
function sinfn() {
    ...
    var n = document.getElementById("history"), i = n.value.indexOf("Enter");
    i < 0 && (n.value += "\nEnter angle in degree.", gfg_Run())
}
